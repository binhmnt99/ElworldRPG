namespace RPG.CustomGuid
{
    using System;

    public static class GuidExtensions
    {
        public static SerializableGuid ToSerializableGuid(this System.Guid systemGuid)
        {
        ...
        public static System.Guid ToSystemGuid(this SerializableGuid serializableGuid)
        {
